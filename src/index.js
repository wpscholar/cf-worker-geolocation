...
async function handle(request) {
  try {
    ...
    try {
      ...
      const airportCode = request.cf.colo;
      ...
      return JSONResponse({message: 'success', ip, country: {code: countryCode, name: country}, airportCode, continent, city, lat, lng, postalCode,region, regionCode, timezone});
    } catch (err) {
      console.log("Error");
      console.log(err);
